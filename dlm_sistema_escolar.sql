...
INSERT INTO professor (instituicaoId, nome, cpf, email, titulacao) VALUES
...
INSERT INTO aluno (nome, cpf, email, data_nasc, telefone) VALUES
...
INSERT INTO turma (instituicao_id, professor_id, nome, ano_letivo, turno, vagas) VALUES
    (1, 1, '3º A Manhã',     2025, 'MANHA',   35),
    (1, 3, '2º B Tarde',     2025, 'TARDE', 30),
    (2, 2, 'SI Noturno T01', 2025, 'NOITE',    40);
